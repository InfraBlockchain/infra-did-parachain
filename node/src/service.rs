...
/// Native Newnal executor instance.
pub struct NewnalRuntimeExecutor;

impl sc_executor::NativeExecutionDispatch for NewnalRuntimeExecutor {
    type ExtendHostFunctions = frame_benchmarking::benchmarking::HostFunctions;

    fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
        infra_did_parachain_runtime::api::dispatch(method, data)
    }

    fn native_version() -> sc_executor::NativeVersion {
        infra_did_parachain_runtime::native_version()
    }
}
    ...
    start_node_impl::<RuntimeApi, _, _, _>(
        ...
        |client,
         ...
         announce_block| {
            ...
            let spawner = task_manager.spawn_essential_handle();
            spawner.spawn_essential("cumulus-newnal-collator", None, collation_future);
