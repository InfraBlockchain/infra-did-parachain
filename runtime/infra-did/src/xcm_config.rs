...
pub type MultiAssetTransactor = MultiAssetAdapter<
    ...
    ConvertedConcreteAssetId<CommonAssetId, Balance, AssetIdLocationConvert<AssetManager>, JustTry>,
>;
...
pub type XcmFeesToAccount = common_primitives::xcm::XcmFeesToAccount<
    AccountId,
    Assets,
    ConvertedConcreteAssetId<CommonAssetId, Balance, AssetIdLocationConvert<AssetManager>, JustTry>,
    XcmFeesAccount,
...
where
    AssetXConverter: xcm_executor::traits::Convert<MultiLocation, CommonAssetId>,
{
