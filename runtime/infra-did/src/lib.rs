...
impl Contains<RuntimeCall> for BaseFilter {
    fn contains(call: &RuntimeCall) -> bool {
        ...
        match call {
            ...
            | RuntimeCall::CollatorSelection( collator_selection::Call::register_as_candidate{..})
            ...
            | RuntimeCall::CollatorSelection(
                collator_selection::Call::set_invulnerables{..}
                | collator_selection::Call::set_desired_candidates{..}
                | collator_selection::Call::set_candidacy_bond{..}
                | collator_selection::Call::set_eviction_baseline{..}
                | collator_selection::Call::set_eviction_tolerance{..}
                | collator_selection::Call::register_candidate{..}
                | collator_selection::Call::remove_collator{..}
                | collator_selection::Call::leave_intent{..})
...
impl collator_selection::Config for Runtime {
    ...
    type WeightInfo = weights::collator_selection::SubstrateWeight<Runtime>;
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        // DID
        BbsPlus: bbs_plus::{Pallet, Call, Storage, Event} = 51,
        DIDModule: did::{Pallet, Call, Storage, Event, Config} = 52,
        Revoke: revoke::{Pallet, Call, Storage, Event} = 53,
        BlobStore: blob::{Pallet, Call, Storage} = 54,
        Master: master::{Pallet, Call, Storage, Event<T>, Config} = 55,
