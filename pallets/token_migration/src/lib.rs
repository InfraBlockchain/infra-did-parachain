...
decl_module! {
    ...
    pub struct Module<T: Config> for enum Call where origin: T::RuntimeOrigin {
        ...
        pub fn migrate(origin, recipients: BTreeMap<T::AccountId, BalanceOf<T>>) -> DispatchResult {
        ...
        pub fn expand_migrator(origin, migrator: T::AccountId, increase_migrations_by: u16) -> DispatchResult {
            ensure_root(origin)?;
        ...
        #[weight = T::DbWeight::get().reads_writes(1, 1)]
        pub fn contract_migrator(origin, migrator: T::AccountId, decrease_migrations_by: u16) -> DispatchResult {
            ensure_root(origin)?;
        ...
        /// Add a new migrator
        #[weight = T::DbWeight::get().reads_writes(1, 1)]
        pub fn add_migrator(origin, migrator: T::AccountId, allowed_migrations: u16) -> DispatchResult {
            ensure_root(origin)?;
        ...
        #[weight = T::DbWeight::get().reads_writes(1, 1)]
        pub fn remove_migrator(origin, migrator: T::AccountId) -> DispatchResult {
            ensure_root(origin)?;
        ...
        pub fn give_bonuses(origin, swap_bonus_recips: Vec<(T::AccountId, BalanceOf<T>, u32)>, vesting_bonus_recips: Vec<(T::AccountId, BalanceOf<T>, u32)>) -> DispatchResult {
            let migrator = ensure_signed(origin)?;
        ...
        /// # </weight>
        #[weight = T::DbWeight::get().reads_writes(1, 1)]
        pub fn claim_bonus(origin) -> DispatchResult {
        ...
        pub fn claim_bonus_for_other(origin, target: <T::Lookup as StaticLookup>::Source) -> DispatchResult {
        ...
        /// # </weight>
        #[weight = T::DbWeight::get().reads_writes(1, 1)]
        pub fn claim_swap_bonus(origin) -> DispatchResult {
            let who = ensure_signed(origin)?;
        ...
        /// # </weight>
        #[weight = T::DbWeight::get().reads_writes(2, 2)]
        pub fn claim_swap_bonus_for_other(origin, target: <T::Lookup as StaticLookup>::Source) -> DispatchResult {
            ensure_signed(origin)?;
        ...
        /// # </weight>
        #[weight = T::DbWeight::get().reads_writes(1, 1)]
        pub fn claim_vesting_bonus(origin) -> DispatchResult {
            let who = ensure_signed(origin)?;
        ...
        /// # </weight>
        #[weight = T::DbWeight::get().reads_writes(2, 2)]
        pub fn claim_vesting_bonus_for_other(origin, target: <T::Lookup as StaticLookup>::Source) -> DispatchResult {
            ensure_signed(origin)?;
...
where
    <T as system::Config>::RuntimeCall: IsSubType<Call<T>>,
{
    const IDENTIFIER: &'static str = "OnlyMigrator";
    type AccountId = T::AccountId;
    type Call = <T as system::Config>::RuntimeCall;
