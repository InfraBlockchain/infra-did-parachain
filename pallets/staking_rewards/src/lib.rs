...
use frame_support::{
    decl_event, decl_module, decl_storage, dispatch::Pays,
    pallet_prelude::DispatchResultWithPostInfo, traits::Get, weights::Weight,
};
...
decl_module! {
    pub struct Module<T: Config> for enum Call where origin: T::RuntimeOrigin {
        ...
        pub fn set_emission_status(origin, status: bool) -> DispatchResultWithPostInfo {
            ensure_root(origin)?;
